<%@ attribute name="id" %><%@ attribute name="name" %><%@ attribute name="style" %><%@ attribute name="uploadBtn"%><%@ attribute name="url" %><%@ attribute name="maxFileSize" %><%@ attribute name="cls" %><%@ attribute name="componentCls" %><%@ attribute name="rendered" type="java.lang.Boolean" %><%@ attribute name="authorized" %><%@ attribute name="filesUrl" %><%@ attribute name="acceptFileTypes" %><%@ attribute name="required" type="java.lang.Boolean" %><%@ attribute name="multiple" type="java.lang.Boolean" %><%@ attribute name="formData" %><%@ attribute name="filesLimt" %><%@ attribute name="fileObjName" %><%@ attribute name="uploadBtnOptions" %><%@ attribute name="onSelect" %><%@ attribute name="queueID" %><%@ attribute name="queueMode" %><%@ attribute name="onFail" %><%@ attribute name="onRemove" %><%@ attribute name="onComplete" %><%@ attribute name="onCreate" %><%@ attribute name="onStart" %><%@ attribute name="onSend" %><%@ attribute name="onProgress" %><%@ attribute name="onSuccess" %><%@ include file="TagUtil.jsp" %><% String dataOption = tagUtil.add("name", name)
.add("id", id)
.add("cls", cls)
.add("style", style)
