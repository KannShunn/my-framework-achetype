<%@attribute name="id"%><%@ attribute name="firstIsactive" type="java.lang.Boolean" %><%@attribute name="style"%><%@attribute name="simpleDataIdKey"%><%@attribute name="isactiveField"%><%@attribute name="simpleDataPIdKey"%><%@attribute name="nameField"%><%@ attribute name="autoDisplay" type="java.lang.Boolean" %><%@attribute name="collapseIcon"%><%@attribute name="expandIcon"%><%@ attribute name="collapseButton" type="java.lang.Boolean" %><%@ attribute name="singleOpen" type="java.lang.Boolean" %><%@ attribute name="simpleDataEnable" type="java.lang.Boolean" %><%@ attribute name="minmenu" type="java.lang.Boolean" %><%@ attribute name="responsive" type="java.lang.Boolean" %><%@ attribute name="vertical" type="java.lang.Boolean" %><%@ attribute name="cls" %><%@ attribute name="componentCls" %><%@ attribute name="rendered" type="java.lang.Boolean" %><%@ attribute name="authorized" %><%@attribute name="name"%><%@attribute name="data"%><%@attribute name="disabled"%><%@attribute name="url"%><%@attribute name="method"%><%@attribute name="onclick"%><%@attribute name="onItemClick"%><%@attribute name="onClick"%><%@attribute name="onCreate"%><%@include file="TagUtil.jsp" %><% 
